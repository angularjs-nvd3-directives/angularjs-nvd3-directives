...
title: multibarchart
layout: example
description: d3.js, nvd3.js Multi Bar Charts with Angular.js Directives
---
...
## Rotate Labels
Used to calculate the degree of rotation for the axis labels
