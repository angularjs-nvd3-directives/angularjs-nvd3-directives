...
title: legends
layout: example
description: d3.js, nvd3.js, Angular.js, legend, legends, tooltip, mouseover, mouseout, mousemove
---
<script>
...
Legends in nvd3 are chart components.  They can be configured much like the parent chart.
...
## Legend Width
Controls the display width of the legend.
Datatype: Number

{% highlight html %}
<div ng-controller="ExampleCtrl">
	<nvd3-line-chart
        id="legendWidthexampleId"
    	data="exampleData"
        width="550"
        height="350"
        legendWidth="400"
...
## Legend Height
Controls the display height of the legend.
Datatype: Number
