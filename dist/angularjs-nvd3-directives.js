/*! angularjs-nvd3-directives - v0.0.8 - 2015-12-22
              ...
              nv.addGraph( {
                generate: function () {
                  ...
                  var chart = nv.models.scatterChart().width( scope.width ).height( scope.height ).margin( scope.margin ).x( attrs.x === undefined ? function ( d ) {
                    ...
                    return d.size === undefined ? 1 : d.size;
                  } : scope.size() ).forceX( attrs.forcex === undefined ? [] : scope.$eval( attrs.forcex ) ).forceY( attrs.forcey === undefined ? [] : scope.$eval( attrs.forcey ) ).forcePoint( attrs.forcesize === undefined ? [] : scope.$eval( attrs.forcesize ) ).interactive( attrs.interactive === undefined ? false : attrs.interactive === 'true' ).showLegend( attrs.showlegend === undefined ? false : attrs.showlegend === 'true' ).showDistX( attrs.showdistx === undefined ? false : attrs.showdistx === 'true' ).showDistY( attrs.showdisty === undefined ? false : attrs.showdisty === 'true' ).noData( attrs.nodata === undefined ? 'No Data Available.' : scope.nodata ).color( attrs.color === undefined ? nv.utils.defaultColor() : scope.color() );
                  // .transitionDuration(attrs.transitionduration === undefined ? 250 : (+attrs.transitionduration))
                  if ( attrs.tooltips !== undefined && attrs.tooltipcontent !== undefined ) {
                    chart.tooltip.enabled( attrs.tooltips === undefined ? false : attrs.tooltips === 'true' );
                    chart.tooltip.contentGenerator( attrs.tooltipContent === undefined ? null : scope.tooltipContent() );
                  }
                  if ( attrs.shape ) {
